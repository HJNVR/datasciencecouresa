...
training <- read.csv("/Users/Starkjing/Desktop/学习/ML/pml-training.csv", na.strings=c("#DIV/0!"), row.names = 1)
testing <- read.csv("/Users/Starkjing/Desktop/学习/ML/pml-testing.csv", na.strings=c("#DIV/0!"), row.names = 1)
